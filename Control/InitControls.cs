...
public class InitControls : MonoBehaviour
{
    private void Awake()
    {
        ...
        if (!SavedData.HasKey("InitControls", SaveMode.Global))
        {
            ...
            Control.SetAxis(SnapAxis.X, KeyCode.D, KeyCode.A, 0);
            Control.SetAxis(SnapAxis.Y, KeyCode.W, KeyCode.S, 0);
            ...
            Control.SetAxis(SnapAxis.X, KeyCode.RightArrow, KeyCode.LeftArrow, 1);
            Control.SetAxis(SnapAxis.Y, KeyCode.UpArrow, KeyCode.DownArrow, 1);
        }
    }
}
